...
Use **[Private vulnerability reporting](https://github.com/tommasomeli/prisma-generator-nestjs-dto/security/advisories/new)** on this repository (Security → **Report a vulnerability**). Include:
